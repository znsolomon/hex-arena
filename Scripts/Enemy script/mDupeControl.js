...
var splitTo : GameObject;
var higherScript : lDupeControl;
...
function OnTriggerEnter2D(other : Collider2D){
	if (other.gameObject.CompareTag("Bullet")){
		...
		Instantiate(splitTo,new Vector3(this.transform.position.x,this.transform.position.y + 5,0),this.transform.rotation);
		Instantiate(splitTo,new Vector3(this.transform.position.x + 5,this.transform.position.y,0),this.transform.rotation);
